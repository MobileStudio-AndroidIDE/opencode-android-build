...
<!-- versions:badges -->
[![opentui-js](https://img.shields.io/badge/opentui--js-@xincli%400.5.1-bun-green.svg)](https://www.npmjs.com/package/@xincli/opentui-core)
[![opentui-so](https://img.shields.io/badge/libopentui.so-@xincli%400.5.1-bun-green.svg)](https://www.npmjs.com/package/@xincli/opentui-core-android-arm64)
<!-- /versions:badges -->
...
| `@opentui/{core,keymap,solid}` (JS, via `@xincli`) | `0.5.1-bun` |
| `@xincli/opentui-core-android-arm64` (native `.so`) | `0.5.1-bun` |
